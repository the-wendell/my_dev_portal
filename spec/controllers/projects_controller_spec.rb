...
RSpec.describe ProjectsController, type: :controller do
  ...
  describe 'projects#create' do
    ...
    it 'Redirects to project view' do
      post :create, params: { project: valid_attributes }
      expect(response).to redirect_to(dashboard_index_path(menu_action: 'view_projects'))
    end
  end
  ...
  describe 'projects#update' do
    it 'Allows use to update project' do
      post :create, params: { project: valid_attributes }
      patch :update, params: { id: portfolio.projects.first.id, project: { title: 'working'} }
  ...
  describe 'projects#destroy' do
    it 'Allows user to delete project' do
      post :create, params: { project: valid_attributes }
      delete :destroy, params: { id: portfolio.projects.first.id }
